...
export const generateBitsArray = (tree: treeArray, resultStringArray: string[], resultBitArray: string[] ,bit: string = ''): void => {
  if(tree[0] !== null) {
...
export const generateResultBits = (plane: string, stringArray: string[], bitArray: string[]): string => {
